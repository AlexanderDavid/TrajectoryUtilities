...
class TrajectoryRenderer:
    def __init__(self, input_filename: Path, fps: float, save_filename: Optional[Path]):
        ...
        ani = animation.FuncAnimation(fig, self._animate, interval=1 / fps * 1000, frames=len(self._times))
        if save_filename:
...
def main():
    ...
    parser.add_argument("--fps", type=float, default=60, help="Frames per second to render at")
    parser.add_argument("--save", type=Path, default=None, help="Path to save the animation to")
